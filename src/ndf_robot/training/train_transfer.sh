...
CUDA_VISIBLE_DEVICES=6 python train_conv_occupancy_net.py --obj_class all --experiment_name conv_occ_hidden32_anyrot_part2 --num_epochs 12 --iters_til_ckpt 1000 --steps_til_summary 100 --batch_size 8 --checkpoint_path ndf_vnn/conv_occ_hidden32_anyrot_1/checkpoints/model_epoch_0011_iter_174000.pth --triplet_loss
