...
CUDA_VISIBLE_DEVICES=5 python train_conv_occupancy_net.py --obj_class all --experiment_name conv_occ_hidden32_anyrot_simlat_100 --num_epochs 12 --iters_til_ckpt 1000 --steps_til_summary 100 --batch_size 8 --checkpoint_path ndf_vnn/conv_occ_hidden32_anyrot_part2_1/checkpoints/model_epoch_0011_iter_179000.pth --triplet_loss
