...
CUDA_VISIBLE_DEVICES=7 python train_conv_occupancy_net.py --obj_class all --experiment_name DEBUG_conv_occ_train_any_rot_hidden4_rot_similar_susuper_aggresive --num_epochs 12 --iters_til_ckpt 1000 --steps_til_summary 100 --batch_size 10 --checkpoint_path ndf_vnn/conv_occ_hidden4_anyrot_6/checkpoints/model_epoch_0011_iter_143000.pth --triplet_loss
